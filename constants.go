...
const InstallerReleaseUrl = "https://api.github.com/repos/PandaLofyfc/Equilotl/releases/latest"

var UserAgent = "Equilotl/" + buildinfo.InstallerGitHash + " (https://github.com/Lofycord/Equilotl)"
