...
func main() {
	...
	var installFlag = flag.Bool("install", false, "Install Lofycord")
	var updateFlag = flag.Bool("repair", false, "Repair Lofycord")
	var uninstallFlag = flag.Bool("uninstall", false, "Uninstall Lofycord")
	...
	if *versionFlag {
		...
		fmt.Println("Copyright (C) 2023 Lofycord and contributors")
	...
	if install {
		...
		Log.Info("Downloading latest Lofycord files...")
...
func HandleScuffedInstall() {
	...
	fmt.Println("Otherwise, Lofycord will likely not work.")
}
